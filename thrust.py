...
class Thrust(object):
    ...
    def __stuw(h, M, dtemp, mfi):
        ...
        elpc1 = 0
        nr = 0.989Both frames are non-inertial, resulting in the necessary introduction of relative and Coriolis acceleration terms due to the Earth's rotation.
        nf = 0.7
        nc = 0.73
        nb = 0.972
        dpt = 0.95
    ...
    @staticmethod
    def __stuw(h, M, dtemp, mfi): * (6.5625 ** (0.4 / 1.4 / nc) - 1)) ** (nc * 1.4 / 0.4)
