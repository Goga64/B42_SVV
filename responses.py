...
t_contorl = np.arange(0, tfinal+dt, dt)
# Symmetric
...
################################# For the state spaces of both symmetric and assymetric cases, 
# the B and D matrices have been given as shaped identty and xero matrices. Once Stefan pushes 
# his correction to system.py to main, change them to C_s, D_s, C_a, D_a
...
# Step
axs[0,0].plot(t, Ys11, color = 'r', label = 'u hat')
axs[0,0].plot(t, Ys21, color = 'g', label = 'alpha')
axs[0,0].plot(t, Ys31, color = 'b', label = 'theta')
axs[0,0].plot(t, Ys41, color = 'y', label = 'q(c^bar/V)')
...
# Impulse
axs[1,0].plot(t, IYs11, color = 'r', label = 'u hat')
axs[1,0].plot(t, IYs21, color = 'g', label = 'alpha')
axs[1,0].plot(t, IYs31, color = 'b', label = 'theta')
axs[1,0].plot(t, IYs41, color = 'y', label = 'q(c^bar/V)')
...
# Step
# aileron
axs[0,1].plot(t, Ya11, color = 'red', label = 'u hat')
axs[0,1].plot(t, Ya21, color = 'green', label = 'alpha')
axs[0,1].plot(t, Ya31, color = 'blue', label = 'theta')
axs[0,1].plot(t, Ya41, color = 'yellow', label = 'q(c^bar/V)')
...
axs[1,1].plot(t, Ya12, color = 'red', label = 'u hat')
axs[1,1].plot(t, Ya22, color = 'green', label = 'alpha')
axs[1,1].plot(t, Ya32, color = 'blue', label = 'theta')
axs[1,1].plot(t, Ya42, color = 'yellow', label = 'q(c^bar/V)')

axs[1,1].set_title('response to rudder step input')

# combined response

axs[2,1].plot(t, Ya_sim1, color = 'red', label = 'u hat')
axs[2,1].plot(t, Ya_sim2, color = 'green', label = 'alpha')
axs[2,1].plot(t, Ya_sim3, color = 'blue', label = 'theta')
axs[2,1].plot(t, Ya_sim4, color = 'yellow', label = 'q(c^bar/V)')

axs[2,1].set_title('simmultaneous response to rudder and aileron step inputs')

# Impulse
# aileron
axs[0,2].plot(t, IYa11, color = 'red', label = 'u hat')
axs[0,2].plot(t, IYa21, color = 'green', label = 'alpha')
axs[0,2].plot(t, IYa31, color = 'blue', label = 'theta')
axs[0,2].plot(t, IYa41, color = 'yellow', label = 'q(c^bar/V)')
...
axs[1,2].plot(t, IYa12, color = 'red', label = 'u hat')
axs[1,2].plot(t, IYa22, color = 'green', label = 'alpha')
axs[1,2].plot(t, IYa32, color = 'blue', label = 'theta')
axs[1,2].plot(t, IYa42, color = 'yellow', label = 'q(c^bar/V)')
